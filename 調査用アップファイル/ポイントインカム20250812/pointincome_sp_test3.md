...
<meta name='ir-site-verification-token' value='-167041019'><!-- impact メディア認証タグ -->
...
<!-- /Geniee Wrapper Head Tag -->
<script async src="https://imp-adedge.i-mobile.co.jp/smarttags/SPcW0oKgxk28kCsin2Qd1Q.js"></script>
<script>
window.smarttag = window.smarttag || {cmd: []}; // アイモバイルSmartTag
...
})(window, document, "clarity", "script", "9a4eyud4l1");
</script>
<link href="/css_new/main.css?d=20250609133652" rel="stylesheet">
<link rel="stylesheet" href="/js/modal/colorbox.css">
<link href="/css_new/main_premiam.css" rel="stylesheet">
<link href="/js_new/source/jquery.fancybox.css?v=2.1.5" media="screen" rel="stylesheet">
<link href="/css_new/style.css" rel="stylesheet">
<link href="/js_new/owl-carousel/owl.carousel.css" rel="stylesheet">
<link href="/js_new/owl-carousel/owl.theme.css" rel="stylesheet">
<link href="/css_new/jquery-ui.min.css" rel="stylesheet">
<link href="/css_new/sujest.css" rel="stylesheet">
<!--<link href="/info/css/style.css" rel="stylesheet">--><link rel="stylesheet" href="/css_new/ad_no.css?d=0.74473300 1754975125">
</head>
<body>
<div id="all_wrap">
<script>
    $(document).ready(function() {
        var currentPoint = parseInt('');
        var initPoint = parseInt('');

        // 値チェック
        if (isNaN(currentPoint) || isNaN(initPoint)) {
            return;
        }

        // pt変動してたらアニメーション開始
        //if( initPoint < currentPoint ){
        if (initPoint != currentPoint) {
            $('.pt_count').countTo({
                from: initPoint, // 初期値
                to: currentPoint, // 現在のpt数
                speed: 2000,
                formatter: function(value, options) { // カンマを追加
...
<!-- Google Tag Manager (noscript) #12644 -->
                        ...
                        <li><a href="/list.php?mode=6">50%還元以上</a></li>
                                ...
                                <a href="/list.php?group=65">有名ショップ</a>
                                                                    <ul class="mega_in_menu mega_posi_01">
                                                                                    ...
                                                                                    <li><a href="/list.php?category=229">インテリア</a></li>
                                                                                    <li><a href="/list.php?category=244">チケット・クーポン</a></li>
                                                                                    <li><a href="/list.php?category=245">中古品・オークション</a></li>
                                                                                    <li><a href="/list.php?category=246">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=152">ファッション</a>
                                                                    <ul class="mega_in_menu mega_posi_02">
                                                                                    <li><a href="/list.php?category=177">ファッションモール</a></li>
                                                                                    <li><a href="/list.php?category=179">キッズ・ベビー</a></li>
                                                                                    <li><a href="/list.php?category=247">インナー・下着</a></li>
                                                                                    <li><a href="/list.php?category=178">ファッション雑貨</a></li>
                                                                                    <li><a href="/list.php?category=248">スポーツウェア</a></li>
                                                                                    <li><a href="/list.php?category=249">スーツ・ビジネス用品</a></li>
                                                                                    <li><a href="/list.php?category=262">シューズ</a></li>
                                                                                    <li><a href="/list.php?category=250">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=154">グルメ</a>
                                                                    <ul class="mega_in_menu mega_posi_03">
                                                                                    <li><a href="/list.php?category=251">食品・ネットスーパー</a></li>
                                                                                    <li><a href="/list.php?category=184">スイーツ・お菓子</a></li>
                                                                                    <li><a href="/list.php?category=185">飲料・お酒</a></li>
                                                                                    <li><a href="/list.php?category=263">お取り寄せ</a></li>
                                                                                    <li><a href="/list.php?category=252">出前・デリバリー</a></li>
                                                                                    <li><a href="/list.php?category=264">モニター・お試し</a></li>
                                                                                    <li><a href="/list.php?category=265">定期便</a></li>
                                                                                    <li><a href="/list.php?category=183">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=148">美容・健康</a>
                                                                    <ul class="mega_in_menu mega_posi_04">
                                                                                    <li><a href="/list.php?category=253">モニター・お試し</a></li>
                                                                                    <li><a href="/list.php?category=169">サプリ・健康食品</a></li>
                                                                                    <li><a href="/list.php?category=166">スキンケア</a></li>
                                                                                    <li><a href="/list.php?category=168">ベースメイク・メイクアップ</a></li>
                                                                                    <li><a href="/list.php?category=167">ヘアケア・ボディケア</a></li>
                                                                                    <li><a href="/list.php?category=255">美容・健康器具</a></li>
                                                                                    <li><a href="/list.php?category=256">ナイトブラ・補正下着</a></li>
                                                                                    <li><a href="/list.php?category=261">ダイエット</a></li>
                                                                                    <li><a href="/list.php?category=254">デンタルケア</a></li>
                                                                                    <li><a href="/list.php?category=171">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=147">衛生用品・コンタクト</a>
                                                                    <ul class="mega_in_menu mega_posi_05">
                                                                                    <li><a href="/list.php?category=162">メガネ・コンタクト</a></li>
                                                                                    <li><a href="/list.php?category=163">衛生用品</a></li>
                                                                                    <li><a href="/list.php?category=164">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=151">エンタメ・家電</a>
                                                                    <ul class="mega_in_menu mega_posi_06">
                                                                                    <li><a href="/list.php?category=173">PC・スマホ・周辺機器</a></li>
                                                                                    <li><a href="/list.php?category=174">TV・家電</a></li>
                                                                                    <li><a href="/list.php?category=175">ゲーム・本・音楽</a></li>
                                                                                    <li><a href="/list.php?category=176">おもちゃ・ホビー</a></li>
                                                                                    <li><a href="/list.php?category=230">スポーツ・アウトドア</a></li>
                                                                                    <li><a href="/list.php?category=225">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=155">住まい・暮らし</a>
                                                                    <ul class="mega_in_menu mega_posi_07">
                                                                                    <li><a href="/list.php?category=195">家具・インテリア</a></li>
                                                                                    <li><a href="/list.php?category=257">キッチン・バス用品</a></li>
                                                                                    <li><a href="/list.php?category=258">日用品・雑貨</a></li>
                                                                                    <li><a href="/list.php?category=194">ベビー・マタニティ</a></li>
                                                                                    <li><a href="/list.php?category=196">ギフト・花</a></li>
                                                                                    <li><a href="/list.php?category=193">ペット用品</a></li>
                                                                                    <li><a href="/list.php?category=259">ネットプリント・印刷</a></li>
                                                                                    <li><a href="/list.php?category=260">その他</a></li>
                                                                            </ul>
                                                            </li>
                                                    <li>
                                <a href="/list.php?group=153">その他</a>
                                                            </li>
                                            </ul>
                </div>
            </li>
            <li class="nav_title">
                <a href="/contents/research/" class="nav_title_a research"><span>アンケート</span></a>
                <div class="mega_menu_box">
                    <ul class="mega_menu clearfix">
                        <li><a href="/contents/research/personalize_enquete/">パーソナライズアンケート</a></li>
                        <li><a href="/contents/research/research_enquete/">リサーチアンケート</a></li>
                        <li><a href="/contents/research/web_enquete/">ポ太郎調査団</a></li>
                        <li><a href="/contents/research/receipt/tentame.php">テンタメ</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav_title">
                <a href="/contents/tokumoni/" class="nav_title_a mnt_corn">
                    <span>モニター</span>
                </a>
                <div class="mega_menu_box">
                    <ul class="mega_menu clearfix">
                        <li><a href="/contents/tokumoni/">トクモニ</a></li>
                        <li><a href="/contents/research/receipt/tentame.php">テンタメ</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav_title">
                <a href="/campaign/" class="nav_title_a campaign"><span>キャンペーン</span></a>
            </li>
            <li class="nav_title">
                <a href="/share_cpn/" class="nav_title_a share">
                    <span>お友達紹介</span>
                </a>
            </li>
            <li class="nav_title">
                <a href="/my/my_page.php" class="nav_title_a my_page"><span>マイページ</span></a>
            </li>
        </ul>
    </div><!-- navi_box -->
        ...
        <li class="float">
            ...
            <div class="adnet_block_css" style="position: relative; width: 300px; height: 250px; margin-left: auto; margin-right: auto; text-align: center; overflow: hidden;">
                ...
                <div id='div-imp-smarttag-1897257-0' data-smarttag-spot='1897257'>
                    <script>
                        smarttag.cmd.push(function() { smarttag.display('div-imp-smarttag-1897257-0'); });
                    </script>
                </div>
            </div>
         </li>
