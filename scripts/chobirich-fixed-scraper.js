...
class ChobirichFixedScraper {
  ...
  async init() {
    console.log('ちょびリッチ修正版スクレイパー起動中...\n');
    ...
    try {
      ...
      const campaign = await page.evaluate(() => {
        ...
        const findCashback = () => {
          ...
          // 方法2: フォントサイズが大きく、メインコンテンツエリア内の要素を優先
  ...
  async scrapeAll() {
    // まず楽天市場でテスト
    console.log('=== テスト: 楽天市場 ===');
    await this.scrapeCampaignDetail('36796');
...
// 実行
async function main() {
  const scraper = new ChobirichFixedScraper();
